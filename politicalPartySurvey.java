 ...
 * Written by Huy Lam
 * for Study.com Computer Science 311: Artificial Intelligence
 * 7/18/2023
 */
...
public class politicalPartySurvey {
    public static void main(String[] args) {
        ...
        createPartyFile("republican.txt");
        createPartyFile("democratic.txt");
        createPartyFile("greenparty.txt");
        createPartyFile("libertarian.txt");
        ...
        // display questions from displayQuestion function, storing answer to tempAnswers
        ...
        // store results to appropriate party text file to load up next time survey is run
        if (answer.equals("A")) {
    ...
    private static int[][] readPreviousIntoArray(Integer questionMax, Integer choiceMax) {
        ...
        String[] filenames = {"republican.txt", "democratic.txt", "greenparty.txt", "libertarian.txt"};
    ...
    private static void saveAnswersToFile(int[][] answers, int[][] tempAnswers, int questionMax, String partyAnswer) {
        ...
        String fileName = partyAnswer + ".txt";
        int newValue = 0;
    ...
    private static String predictParty(String answer, int[][] mostPopular, int questionNumber) {
        ...
        // correspond answer to column number to see most popular party that chose that answer
        if (answer.equals("A")) {
            answerCol = 0;
        }
        if (answer.equals("B")) {
    ...
    switch (questionNumber) {
        ...
        case 3:
            ...
            System.out.println("C. Advocate for radical changes to eliminate all pollution and protect ecosystems.");
            System.out.println("D. Believe that free markets and individual choices will naturally address environmental concerns.");
            break;
        case 4:
